...
final: prev:
{
  ...
  ddc-matcher_head = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5ad85629b1d91a5c599c742cbbb6e48a8c2933f5";
      sha256 = "0ns500py5aa4klwrrd48a8nx6cvb06dhrwvq8rs6mbiq7v2k0ygk";
    };
  ...
  denops-vim = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "vim-denops";
      repo = "denops.vim";
      rev = "333aa1783352c346cc4fbaa43217bbc1c07ddbaa";
      sha256 = "0fqdbln4qf8d8w8gr0l061g8prnc550l5f8h4pjajnpcaiysrnc4";
    };
  ...
  skkeleton = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "vim-skk";
      repo = "skkeleton";
      rev = "ab8a15d31877db89884589936a4f679afe434d37";
      sha256 = "15lzv15lvvhqdkl1abgqhp8fryfzx9w30dipllh3zcw40bcz0i2m";
    };
