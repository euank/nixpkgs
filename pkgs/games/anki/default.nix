...
let
  ...
  cargoDeps = rustPlatform.fetchCargoTarball {
    inherit src;
    hash = "sha256-m/dcDo9RcVePM+bEEANBY0OZo8+NoK5bYmQJVO9OoHE=";
  };
...
python39.pkgs.buildPythonApplication {
  ...
  patches = [
    ...
    # already
    ./0001-Don-t-download-nodejs-if-NODE_BINARY-is-set.patch
    ./0002-Allow-setting-YARN_BINARY-for-the-build-system.patch
  ];
  ...
  nativeCheckInputs = with python39.pkgs; [ pytest mock astroid  ];
  ...
  PYTHON_BINARY = lib.getExe python39;
