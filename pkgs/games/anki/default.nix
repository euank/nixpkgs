...
let
  ...
  yarnHash = "sha256-VpcqQcwkZ1TtOl1xfT3AN9aRqlisgbw3QLVbGfr+ADI=";
...
python3.pkgs.buildPythonApplication {
  ...
  buildPhase = ''
    ...
    ${yarn-berry}/bin/yarn config set enableTelemetry false
    ${yarn-berry}/bin/yarn config set enableGlobalCache false
    ${yarn-berry}/bin/yarn config set cacheFolder $cachePath
    ${yarn-berry}/bin/yarn install
